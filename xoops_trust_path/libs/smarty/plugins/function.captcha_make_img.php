 ...
 * Input:    
 * 
 * Examples: {captcha_make_img alt=(<img> alt) style=(<img> style)}
 * -------------------------------------------------------------
 */
function smarty_function_captcha_make_img($params, &$smarty)
{
